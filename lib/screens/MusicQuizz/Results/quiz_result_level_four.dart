...
class QuizResultLevelFourScreen extends StatefulWidget {
  const QuizResultLevelFourScreen({super.key, required this.scoreLevelFour});
  final int scoreLevelFour;

  @override
  State<QuizResultLevelFourScreen> createState() => _QuizResultLevelFourScreenState();
}

class _QuizResultLevelFourScreenState extends State<QuizResultLevelFourScreen> {
