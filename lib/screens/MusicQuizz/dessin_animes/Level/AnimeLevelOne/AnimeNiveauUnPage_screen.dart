...
import 'package:rc_fl_quiz_app/screens/MusicQuizz/dessin_animes/Results/quiz_anime_level_one.dart';
import 'package:rc_fl_quiz_app/screens/MusicQuizz/dessin_animes/data/anime_niveau_un_question_list.dart';
import 'package:flutter/material.dart';
import 'package:audioplayers/audioplayers.dart';
import 'package:rc_fl_quiz_app/theme/theme.dart';

class AnimeNiveauUnPage extends StatefulWidget {
  const AnimeNiveauUnPage({Key? key}) : super(key: key);
  @override
  _AnimeNiveauUnPageState createState() => _AnimeNiveauUnPageState();
}

class _AnimeNiveauUnPageState extends State<AnimeNiveauUnPage> {
  ///PageController
                  ...
                  OutlinedButton(
                    onPressed: isPressed
                      ...
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => QuizAnimeResultLevelOneScreen(scoreLevelOne: scoreUn)
                          ));
                      player.stop();
                    }
                        : () {
