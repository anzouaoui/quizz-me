    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: PageView.builder(
          ...
          itemCount: questions_huit.length,
              ...
              children: [
                      ...
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            Expanded(
                              child: Text(
                                "QUESTION ${index + 1} sur ${questions_huit.length}",
                ...
                IconButton(
                  ...
                  onPressed: () {
                    ...
                    String url = "music/${questions_huit[index].music!}";
                ...
                for (int i = 0; i < questions_huit[index].answer.length; i++)
                  Container(
                    width: 300,
                    ...
                    child: MaterialButton(
                      ...
                      color: isPressed
                          ? questions_huit[index].answer.entries.toList()[i].value
                          ? trueAnswer
                          : falseAnswer
                          : greyColor,
                      ...
                      child: Text(
                        questions_huit[index].answer.keys.toList()[i],
                ...
                Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                  ...
                  OutlinedButton(
                    onPressed: isPressed
                        ? index + 1 == questions_huit.length
                        ? () {
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => QuizResultLevelEightScreen(scoreLevelHuit: scoreHuit)
                          ));
                      player.stop();
                    }
                        : () {
                    ...
                    child: Text(
                      ///Si on arrive à la fin des questions_huit du niveau, alors on affiche le résultat
                      index + 1 == questions_huit.length
                          ? "Voir les résultats"
                          : "Suivant",
                      style: const TextStyle(
