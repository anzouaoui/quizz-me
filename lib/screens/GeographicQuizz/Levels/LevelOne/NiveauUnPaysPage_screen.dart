...
class NiveauUnPaysPage extends StatefulWidget {
  const NiveauUnPaysPage({Key? key}) : super(key: key);
  @override
  _NiveauUnPaysPageState createState() => _NiveauUnPaysPageState();
}

class _NiveauUnPaysPageState extends State<NiveauUnPaysPage> {
  ///PageController
            ...
            return ListView(
              children: [
                      ...
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            Expanded(
                              child: Text(
                                "QUESTION ${index + 1} sur ${pays_un.length}",
                ...
                ///Affichage du drapeau
                  Image(
                      image: AssetImage("geographic/${pays_un[index].flag}"),
                  ),
                const SizedBox(
                  height: 20.0,
                ),
                ...
                for (int i = 0; i < pays_un[index].answer.length; i++)
                  Container(
                    ...
                    child: MaterialButton(
                      ...
                      color: isPressed
                          ? pays_un[index].answer.entries.toList()[i].value
                          ? trueAnswer
                          : falseAnswer
                          : greyColor,
                      ...
                      child: Text(
                        pays_un[index].answer.keys.toList()[i],
                ...
                Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                  ...
                  OutlinedButton(
                    ...
                    child: Text(
                      ///Si on arrive à la fin des pays_un du niveau, alors on affiche le résultat
                      index + 1 == pays_un.length
                          ? "Voir les résultats"
                          : "Suivant",
                      style: const TextStyle(
