...
class CapitaleQuizResultLevelOneScreen extends StatefulWidget {
  const CapitaleQuizResultLevelOneScreen({super.key, required this.scoreLevelOne});
  final int scoreLevelOne;

  @override
  State<CapitaleQuizResultLevelOneScreen> createState() => _CapitaleQuizResultLevelOneScreenState();
}

class _CapitaleQuizResultLevelOneScreenState extends State<CapitaleQuizResultLevelOneScreen> {
